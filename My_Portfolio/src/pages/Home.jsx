    ...
    return (
        <div>
                ...
                <div className='w-3/4 h-3/4 shadow-[inset_0_-2px_4px_rgba(0,0,0,0.6)] rounded-[25px] md:space-y-0 space-y-10 md:p-0 p-2'>
                    ...
                    <div className=' bg-opacity-40 pt-5 flex items-center justify-center text-white font-spartan font-light text-[20px] md:text-[26.26px] space-x-[20%] md:space-x-32'>
                        <Scroll
                            ...
                            duration={500}>
                            <button
                                className='bg-white bg-opacity-50 inline-block px-3 py-1 md:px-6 md:py-2 duration-200 hover:bg-blue-100 hover:text-black rounded-full cursor-pointer shadow-[rgba(0,0,15,0.5)_10px_5px_4px_0px] border-black'
                            >
                                About
                            </button>
                        </Scroll>
            ...
            <div className='w-full h-screen flex items-center justify-center' id='about'>
                <div className='md:w-3/4 md:h-3/4 w-11/12 h-11/12 flex items-center bg-midblue rounded-[25px]'>
                    <div className=' w-full h-fit  flex items-center md:flex-row flex-col'>
                        ...
                        <div className=' w-full h-full flex items-center'>
                            <div className='flex flex-col space-y-10 w-full text-white font-spartan md:m-0 m-4'>
