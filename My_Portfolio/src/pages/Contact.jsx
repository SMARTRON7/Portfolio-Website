    ...
    return (
        <div className='w-full h-full bg-darkblue'>
            <div className='w-full h-screen flex items-center justify-center'>
                <form className='w-11/12 h-3/4 flex flex-col mt-10 bg-midblue rounded-[25px] shadow-[inset_0_-2px_4px_rgba(0,0,0,0.6)]' onSubmit={handleSubmit(submit)}>
                    <div className=' '>
                        <div>
                        ...
                        <div className='flex flex-col items-center'>
                            <div className=' flex flex-col items-center md:justify-center'>
                                ...
                                <div className='h-full flex flex-wrap items-center md:pl-5 md:justify-center font-semibold font-spartan text-xs md:text-sm text-white mt-4'>
                                    <ul>
                            ...
                            <div className=' w-full flex flex-col items-center mt-10 text-white '>
                                <div className='flex flex-col items-start space-y-10'>
                                    <div className='flex flex-row items-start justify-start space-x-4'>
                                        ...
                                        <input type="text" id="first_name" className="h-fit bg-transparent underline !outline-none text-white rounded-lg" placeholder="John" required {...register("Name", { required: true })} />
                                    </div>
                                    <div className='flex flex-row items-start justify-start space-x-4'>
                                        <label htmlFor="first_name" className="h-fit text-xl font-medium text-white font-spartan">Email:</label>
                                        <input type="text" id="first_name" className="h-fit bg-transparent underline !outline-none text-white rounded-lg" placeholder="John@gmail.com" required {...register("Email", { required: true })} />
                                    </div>
                                    <div className='flex flex-row items-start justify-start space-x-4'>
                                        <label htmlFor="first_name" className="h-fit text-xl font-medium text-white font-spartan">Contact:</label>
                                        <input type="text" id="first_name" className="h-fit bg-transparent underline !outline-none text-white rounded-lg" placeholder="999999999" {...register("Phone", { required: false })} />
                                    </div>
                                </div>
                            </div>
                        </div>
